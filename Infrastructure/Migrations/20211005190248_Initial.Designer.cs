...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20211005190248_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Domain.People.Appointment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Domain.People.Availability", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime>("TimeMax")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("TimeMin")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Core.Domain.People.Availability", b =>
                {
                    b.HasOne("Core.Domain.People.Intern", null)
                        .WithMany("Availabilities")
                        .HasForeignKey("InternId");

                    b.HasOne("Core.Domain.People.Physiotherapist", null)
                        .WithMany("Availabilities")
